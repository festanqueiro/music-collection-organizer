...
// Full-screen queue view, shown as an overlay above the toolbar/left/
// center/right grid areas while the footer Player (with its own compact
// transport strip and down-chevron trigger) stays mounted underneath —
// so playback is never interrupted by expanding/collapsing this view.
